        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PwdExpiryDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    PwdChangedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ForcePwdChange = table.Column<bool>(type: "bit", nullable: false),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    ConfirmationLinkExpireDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RegistrationOTP = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RegistrationExpireOTP = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ForgetPasswordOTP = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ForgetPasswordExpireOTP = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModuleAction = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmailAttachment_EmailLogs_EmailLogId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmailAttachment_EmailLogId",
